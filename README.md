...
This board is slightly custom, INTAK and INT have been routing through DRQ2 and DACK2 to allow external PIC-board in the BUS, also HLDA and HOLD have been routed through DACK3 and DRQ3 to allow DMAC-board in the BUS (these mean that DMA channels 2 and 3 cannot be normally used). The board will boot when RESET jumper is connected being initially disconnected. There are 3 other jumpers for allowing operation with or without PIC and DMAC.
